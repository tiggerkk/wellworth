...
--
-- Additive preference columns for the Quotes module. They are plain columns on the existing profile
...
--   * quote_importer_enabled — surfaces the in-app CSV importer in Quotes Settings. ON by default
--     (the owner imports their existing library on first run); toggleable off in Quotes Settings.
