...
import {
  ...
  WellnessDashboard,
  WellnessDiary,
  WellnessDiaryFoodPickerSheet,
  WellnessDiaryFoodDetailSheet,
  WellnessDiaryActivityPickerSheet,
  WellnessDiaryActivityDetailSheet,
  WellnessLibrary,
  WellnessFoodEntry,
  WellnessActivityEntry,
  WellnessSettings,
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'wellness/add-food', element: <WellnessDiaryFoodPickerSheet /> },
          {
            path: 'wellness/food/:source/:id',
            element: <WellnessDiaryFoodDetailSheet />,
          },
          {
            path: 'wellness/add-activity',
            element: <WellnessDiaryActivityPickerSheet />,
          },
          {
            path: 'wellness/activity/:activityId',
            element: <WellnessDiaryActivityDetailSheet />,
          },
          { path: 'wellness/library', element: <WellnessLibrary /> },
          { path: 'wellness/new-food', element: <WellnessFoodEntry /> },
          { path: 'wellness/edit-food/:id', element: <WellnessFoodEntry /> },
          { path: 'wellness/new-activity', element: <WellnessActivityEntry /> },
          { path: 'wellness/edit-activity/:id', element: <WellnessActivityEntry /> },
          ...
          { path: 'quotes/settings/moods', element: <JournalMoodsSheet /> },
          ...
          { path: 'quotes/journal/dashboard', element: <JournalDashboard /> },
