 ...
 * `templates/custom-foods-import-guide.md`). Turns parsed CSV rows into food records ready for
 * `importCustomFoods`, collecting blocking errors and non-blocking warnings for a preview. No I/O.
 */
