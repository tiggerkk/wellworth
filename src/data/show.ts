 ...
 * (`matchesCriteria`/`sortKey`: type/status/favorite/notes/lgbtq/dynasty/genre/rating/dates/year).
 * Deliberately omits `overview`, `imdb_id`, `tmdb_id`, `original_language`, `created_at`
