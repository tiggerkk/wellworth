 ...
 *  across all history (`listSnapshots`) just to read the last one; this grows unbounded with
 *  months of use, the same class of issue `networth_monthly_type_total` was introduced to fix
 *  for `asset_entry`. */
