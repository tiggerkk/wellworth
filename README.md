...
Shows (TV, movies & documentaries, incl. Chinese titles/documentaries with a master series; Chinese-aware TMDB metadata, a pasted Poster URL + per-show Refresh, dashboard shelves, a filterable/sortable library, field-visibility settings, and a CSV importer; shares only auth/profile and the app shell).
