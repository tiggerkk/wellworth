...
- **templates/** — `custom-foods-template.csv` + an import guide for bulk-adding custom foods/supplements (used by Library → **Import CSV**), and `networth-seed-template.csv` + `networth-import-guide.md` for the Net Worth importer (sanitized example; your real balances stay gitignored).
...
3. Build **one milestone at a time**. Wellness and Net Worth shipped.
